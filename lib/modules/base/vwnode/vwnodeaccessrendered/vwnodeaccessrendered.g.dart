...
VwNodeAccessRendered _$VwNodeAccessRenderedFromJson(Map<String, dynamic> json) {
      try

          {
                return VwNodeAccessRendered(
      ...
      {
       print("Error catched on VwNodeAccessRenderedFromJson(Map<String, dynamic> json) "+error.toString());
      }
      return VwNodeAccessRendered(
            renderedDate: DateTime.parse(json['renderedDate'] as String),
            ownerUser: json['ownerUser'] == null
